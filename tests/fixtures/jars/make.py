...
def nei_dumps(root: Path) -> Path:
    ...
    (root / "block.csv").write_text(
        ...
        "minecraft:planks,5,true,minecraft,net.minecraft.block.BlockWood,Wooden Planks\n"
        "minecraft:glass_pane,102,true,minecraft,net.minecraft.block.BlockPane,Glass Pane\n"
        "minecraft:wooden_door,64,true,minecraft,net.minecraft.block.BlockDoor,Wooden Door\n"
